...
![Untitled](assets/img/media/post_img/codeengn/basic-rce-L03Untitled%201.png)

---

문자열 비교함수 이름을 찾기 위해서 xdbg를 사용하여 디버깅을 해보았습니다.

![Untitled](assets/img/media/post_img/codeengn/basic-rce-L03Untitled%202.png)

문자열 참조로 모든 문자열을 보았을때 `Error ! Das Passwort ist falsch !"` 라는 부분위 쪽에 스트링 비교함수가 있을꺼 같아서 위치로 가보았습니다.

![Untitled](assets/img/media/post_img/codeengn/basic-rce-L03Untitled%203.png)
